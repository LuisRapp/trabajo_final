...
<div class="container-fluid py-4">
    ...
    @else
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 text-success">${{ number_format($estadisticas_globales['precio_promedio'], 2) }}/tn</h4>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 text-warning">${{ number_format($estadisticas_globales['costo_promedio'], 2) }}/tn</h4>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 text-info">${{ number_format($estadisticas_globales['punto_equilibrio'], 2) }}/tn</h4>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        ...
                        <h4 class="mb-0 {{ $estadisticas_globales['rentabilidad_promedio'] >= 0 ? 'text-success' : 'text-danger' }}">
                            ...
                            @foreach($lotes_estadisticas as $stat)
                                <tr>
                                    <td class="fw-bold text-dark" style="word-break: break-word; padding: 15px;">
                                        <span style="display: block; font-size: 14px;">{{ $stat['nombre'] ?? 'Sin nombre' }}</span>
                                    </td>
                                    <td style="padding: 15px;">{{ number_format($stat['hectareas'], 2) }} ha</td>
                                    ...
                                    <td style="padding: 15px;">
                                        <span class="badge {{ $stat['rentabilidad'] >= 0 ? 'bg-success' : 'bg-danger' }}-light text-{{ $stat['rentabilidad'] >= 0 ? 'success' : 'danger' }}" style="display: block; word-wrap: break-word;">
                                            ${{ number_format($stat['rentabilidad'], 2) }}/tn
                                        </span>
                                    </td>
                                    <td style="padding: 15px;">
                                        <span class="badge {{ $stat['rentabilidad'] >= 0 ? 'bg-success' : 'bg-danger' }}" style="display: block; text-align: center;">
        ...
        <div class="alert alert-secondary mb-0">
            ...
            <strong>Resumen:</strong> Analizando {{ $estadisticas_globales['total_lotes'] }} lote(s) activo(s) 
            con rentabilidad promedio de <strong>${{ number_format($estadisticas_globales['rentabilidad_promedio'], 2) }}/tn</strong>.
        </div>
    @endif
</div>
