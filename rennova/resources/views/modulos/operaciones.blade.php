        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="card h-100 border-0 shadow-sm hover-elevate">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('proveedores.index') }}" class="btn btn-outline-success stretched-link w-100">
                        Gestionar
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="card h-100 border-0 shadow-sm hover-elevate">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('insumos.index') }}" class="btn btn-outline-success stretched-link w-100">
                        Gestionar
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="card h-100 border-0 shadow-sm hover-elevate">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('modulos.operaciones.gestionstock') }}" class="btn btn-outline-success stretched-link w-100">
                        Abrir
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="card h-100 border-0 shadow-sm hover-elevate">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('partes-diarios.index') }}" class="btn btn-outline-success stretched-link w-100">
                        Gestionar
                    </a>
                </div>
            </div>
        ...
        <div class="col-12 col-md-6 col-xl-4">
            <div class="card h-100 border-0 shadow-sm hover-elevate">
                <div class="card-body p-4">
                    ...
                    <a href="{{ route('unidades-medida.index') }}" class="btn btn-outline-success stretched-link w-100">
                        Gestionar
                    </a>
                </div>
            </div>
