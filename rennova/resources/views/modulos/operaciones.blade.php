...
<div class="container py-4">
    ...
    <div class="erp-card-grid">
        <div class="erp-nav-card">
            ...
            <a href="{{ route('proveedores.index') }}" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-box-seam"></i></div>
            <div class="card-title">Insumos</div>
            <a href="{{ route('insumos.index') }}" class="card-btn">Gestionar</a>
        </div>
        ...
        <div class="erp-nav-card">
            ...
            <a href="{{ route('unidades-medida.index') }}" class="card-btn">Gestionar</a>
        </div>
    </div>
</div>
@endsection
