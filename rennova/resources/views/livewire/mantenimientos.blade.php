            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                <div class="bg-slate-100 border-b border-slate-200 px-6 py-4">
                    <h5 class="flex items-center gap-2 text-lg font-semibold text-slate-800 mb-0">
                        <i class="bi bi-{{ $mantenimiento_id ? 'pencil-square' : 'plus-circle' }}"></i> 
                        {{ $mantenimiento_id ? 'Editar Orden' : 'Nueva Orden de Mantenimiento' }}
                    </h5>
                </div>
                <div class="p-6">
                    ...
                    <form wire:submit.prevent="guardar">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input type="date" wire:model="fecha_inicio" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors @error('fecha_inicio') ring-2 ring-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="fecha_programada" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors @error('fecha_programada') ring-2 ring-red-500 @enderror">
                                @error('fecha_programada') <p class="mt-1 text-sm text-red-500">{{ $message }}</p> @enderror
                                <small class="text-slate-500 text-xs mt-1 block">
                                    <i class="bi bi-info-circle"></i> Debe estar dentro de los próximos 7 días ({{ \Carbon\Carbon::now()->format('d/m/Y') }} - {{ \Carbon\Carbon::now()->addDays(7)->format('d/m/Y') }})
                                </small>
                            </div>
                        </div>
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors">
                                        ...
                                        <td class="px-3 py-3 text-center">
                                            ...
                                            <div class="flex gap-1 justify-center">
                                                ...
                                                <button type="button" wire:click.prevent="abrirModalCompletar({{ $mantenimiento->id_mantenimiento }})" title="Completar" class="inline-flex items-center px-2 py-1 bg-green-50 text-green-700 hover:bg-green-100 rounded transition-colors border border-green-200 {{ ($isCompletado || $isVencido) ? 'opacity-50 cursor-not-allowed' : '' }}" @if($isCompletado || $isVencido) disabled @endif>
                ...
                <div class="lw-modal-body">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <input type="date" wire:model="fecha_fin_completar" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors @error('fecha_fin_completar') ring-2 ring-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <input type="number" wire:model="costo_total_completar" step="1" min="0" class="flex-1 px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors @error('costo_total_completar') ring-2 ring-red-500 @enderror" placeholder="0.00">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-3 mb-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <input type="number" wire:model="insumos_usados.{{ $index }}.precio_unitario" step="0.01" min="0" class="flex-1 px-4 py-3 border border-slate-300 rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors" readonly style="background-color: #f8fafc;">
                                </div>
                            </div>
