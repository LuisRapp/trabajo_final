        ...
        <div class="card-body">
            ...
            @if (session()->has('command_output'))
                <div class="alert alert-info alert-dismissible fade show">
                    ...
                    <pre class="mb-0 mt-2" style="white-space: pre-wrap;">{{ session('command_output') }}</pre>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            @endif
                        ...
                        <div class="card-body">
                            <form wire:submit.prevent="guardarConfiguracion">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select wire:model.live="expresion_cron" class="form-select @error('expresion_cron') is-invalid @enderror" id="selectFrecuencia">
                                ...
                                <div class="mb-3" id="customCronDiv" style="display: none;">
                                    ...
                                    <input type="text" 
                                           ...
                                           class="form-control font-monospace @error('expresion_cron') is-invalid @enderror"
                                           placeholder="* * * * *"
                                           id="customCronInput">
                                    <small class="text-muted">
