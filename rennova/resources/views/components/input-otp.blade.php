    ...
    <div class="flex items-center">
        @for ($x = 1; $x <= $digits; $x++)
            <input
                ...
                @class([
                    'flex size-10 items-center justify-center border border-arena bg-accent-foreground text-center text-sm font-medium text-accent-content transition-colors focus:border-accent focus:border-2 focus:outline-hidden focus:relative focus:z-10 dark:border-corteza dark:focus:border-accent',
                    'rounded-l-md' => $x === 1,
