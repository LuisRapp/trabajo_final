{{-- Modal de recomendaciones de asignación automática --}}
@props(['recomendaciones', 'recomendacionesError', 'recomendacionesMensaje', 'modalLoteId', 'editProposalId', 'editData', 'expandedProposalId', 'editingProposals', 'editProposedMaquinarias'])
                        ...
                        <table class="min-w-full mx-auto text-left text-sm text-slate-600">
                            ...
                            <tbody class="divide-y divide-slate-200">
                                @foreach($recomendaciones as $rec)
                                    ...
                                    @endphp
                                    <tr class="cursor-pointer hover:bg-slate-50" wire:click="$dispatch('toggleExpand', { proposalId: {{ $rec->id_allocation_proposal }} })">
                                    ...
                                    @if($expandedProposalId === $rec->id_allocation_proposal)
                                        <tr class="bg-slate-50/70">
                                            <td colspan="6" class="px-4 py-4 text-xs text-slate-600">
                                                @include('components.lotes.proposal-detail', ['rec' => $rec])
                                            </td>
                                        </tr>
                                    @endif
                                @endforeach
