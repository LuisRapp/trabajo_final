                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="width:70px;vertical-align:middle;">
                                        <img src="{{ $logoUrl }}" alt="Rennova" style="max-width:56px;height:auto;display:block;">
                                    </td>
                                    <td style="vertical-align:middle;">
                                        <div style="font-size:18px;font-weight:700;line-height:1.2;">ORDEN DE MANTENIMIENTO</div>
                                        <div style="font-size:12px;opacity:.95;margin-top:2px;">Generado por Sistema | {{ $fechaGeneracion }}</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td style="padding:16px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;font-size:13px;">
                                <tr>
                                    ...
                                    <td style="padding:8px;border:1px solid #e5ebea;">#{{ $mantenimiento->id_mantenimiento }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px;border:1px solid #e5ebea;background:#f8faf9;"><strong>Maquinaria</strong></td>
                                    <td style="padding:8px;border:1px solid #e5ebea;">{{ $mantenimiento->maquinaria->modelo ?? 'N/A' }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px;border:1px solid #e5ebea;background:#f8faf9;"><strong>Fecha programada</strong></td>
                                    <td style="padding:8px;border:1px solid #e5ebea;">{{ $fechaProgramada }}</td>
                                </tr>
                                <tr>
                                    <td style="padding:8px;border:1px solid #e5ebea;background:#f8faf9;"><strong>Tipo de mantenimiento</strong></td>
                                    <td style="padding:8px;border:1px solid #e5ebea;">{{ $mantenimiento->tipoMantenimiento->nombre ?? 'Preventivo' }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding:8px;border:1px solid #e5ebea;">
                                        @if($asignado)
                                            {{ $asignado->apellido }}, {{ $asignado->nombre }} ({{ $asignado->rolLaboral->nombre ?? 'Sin rol' }})
                                        @else
