...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0"><i class="bi bi-pencil-square"></i> Editar Chofer #{{ $chofer->id_chofer }}</h1>
            ...
            <form method="POST" action="{{ route('choferes.update', $chofer) }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="id_cliente" class="form-select @error('id_cliente') is-invalid @enderror" required>
                            ...
                            @foreach($clientes as $cliente)
                                <option value="{{ $cliente->id_cliente }}" @selected(old('id_cliente', $chofer->id_cliente)==$cliente->id_cliente)>
                                    {{ $cliente->nombre }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="apellido" value="{{ old('apellido', $chofer->apellido) }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nombre" value="{{ old('nombre', $chofer->nombre) }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="dni" value="{{ old('dni', $chofer->dni) }}" 
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="telefono" value="{{ old('telefono', $chofer->telefono) }}" 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" role="switch" name="estado" id="estado" value="activo" {{ old('estado', $chofer->estado) == 'activo' ? 'checked' : '' }}>
