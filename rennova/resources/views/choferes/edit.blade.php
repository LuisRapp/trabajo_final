...
<div class="max-w-4xl mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-slate-800 flex items-center gap-2">
            ...
            Editar Chofer #{{ $chofer->id_chofer }}
        </h1>
            ...
            <form method="POST" action="{{ route('choferes.update', $chofer) }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" name="apellido" id="apellido" value="{{ old('apellido', $chofer->apellido) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $chofer->nombre) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" name="dni" id="dni" value="{{ old('dni', $chofer->dni) }}" required
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $chofer->telefono) }}"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-3 mt-2">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="estado" id="estado" value="activo" {{ old('estado', $chofer->estado) == 'activo' ? 'checked' : '' }}
                                    class="sr-only peer">
