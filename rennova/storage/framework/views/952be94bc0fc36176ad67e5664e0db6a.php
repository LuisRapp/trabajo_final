...
<div class="container py-4">
    ...
    <div class="erp-card-grid">
        <div class="erp-nav-card">
            ...
            <a href="<?php echo e(route('maquinarias.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-tools"></i></div>
            <div class="card-title">Mantenimientos</div>
            <a href="<?php echo e(route('mantenimientos.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-gear-fill"></i></div>
            <div class="card-title">Kits de Mantenimiento</div>
            <a href="<?php echo e(route('kits-mantenimiento.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-graph-up"></i></div>
            <div class="card-title">Costos de Maquinaria</div>
            <a href="<?php echo e(route('historico-costos-maquinarias.index')); ?>" class="card-btn">Ver Histórico</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-gear-wide-connected"></i></div>
            <div class="card-title">Tipos de Maquinaria</div>
            <a href="<?php echo e(route('tipos-maquinaria.index')); ?>" class="card-btn">Gestionar</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\trabajo_final\rennova\resources\views/modulos/maquinaria.blade.php ENDPATH**/ ?>