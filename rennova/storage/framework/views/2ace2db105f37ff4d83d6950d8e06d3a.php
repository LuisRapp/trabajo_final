...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="d-flex gap-2 justify-content-end">
                    <!--[if BLOCK]><![endif]--><?php if($recibo_id): ?>
        ...
        <div class="tab-pane fade" id="listado-recibos" role="tabpanel" aria-labelledby="listado-tab">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recibos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recibo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if($recibo->activo): ?>
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/recibos.blade.php ENDPATH**/ ?>