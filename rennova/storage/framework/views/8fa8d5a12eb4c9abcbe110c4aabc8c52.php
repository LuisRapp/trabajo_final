        ...
        <div class="tab-pane fade" id="nuevo-categoria" role="tabpanel">
            <div class="card shadow mb-4">
                <div class="card-header bg-light">
                    <h5 class="mb-0"><i class="bi bi-<?php echo e($categoria_id ? 'pencil-square' : 'plus-circle'); ?>"></i> <?php echo e($categoria_id ? 'Editar Categoría' : 'Nueva Categoría'); ?></h5>
                </div>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" placeholder="Nombre de la categoría">
...
unset($__errorArgs, $__bag); ?>" placeholder="Descripción de la categoría" rows="1"></textarea>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="d-flex gap-2 justify-content-end">
                    <!--[if BLOCK]><![endif]--><?php if($categoria_id): ?>
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> <?php echo e($categoria_id ? 'Actualizar' : 'Guardar'); ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-categorias-madera')): ?>
                                        <button class="btn btn-outline-primary" wire:click="editar(<?php echo e($categoria->id_categoria_madera); ?>)" onclick="cambiarAPestanaFormulario()" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-categorias-madera')): ?>
                                        <button class="btn btn-outline-danger" wire:click="eliminar(<?php echo e($categoria->id_categoria_madera); ?>)" onclick="return confirm('¿Está seguro de eliminar esta categoría?')" title="Eliminar">
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/categorias-madera.blade.php ENDPATH**/ ?>