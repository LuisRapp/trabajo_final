                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-3">
                            ...
                            <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-2 py-1" wire:key="user-<?php echo e($usuario->id); ?>">
                                    ...
                                    <label class="text-sm text-slate-700" for="umbral_<?php echo e($usuario->id); ?>">
                                        <?php echo e($usuario->name); ?> <small class="text-slate-500">(<?php echo e($usuario->email); ?>)</small>
                                    </label>
                                </div>
                        ...
                        <div class="mt-3">
                            ...
                            <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-2 py-1" wire:key="user-<?php echo e($usuario->id); ?>">
                                    ...
                                    <label class="text-sm text-slate-700" for="stock_<?php echo e($usuario->id); ?>">
                                        <?php echo e($usuario->name); ?> <small class="text-slate-500">(<?php echo e($usuario->email); ?>)</small>
                                    </label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="mt-3">
                            ...
                            <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center gap-2 py-1" wire:key="user-<?php echo e($usuario->id); ?>">
                                    ...
                                    <label class="text-sm text-slate-700" for="recordatorio_<?php echo e($usuario->id); ?>">
                                        <?php echo e($usuario->name); ?> <small class="text-slate-500">(<?php echo e($usuario->email); ?>)</small>
                                    </label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
