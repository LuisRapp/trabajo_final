...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="mb-0"><i class="bi bi-pencil-square"></i> Editar Carga #<?php echo e($carga->id_carga); ?></h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('cargas.update', $carga)); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $lotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($lote->id_lote); ?>" <?php if(old('id_lote', $carga->id_lote)==$lote->id_lote): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id_categoria_madera); ?>" <?php if(old('id_categoria_madera', $carga->id_categoria_madera)==$cat->id_categoria_madera): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $partes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($parte->id_parte_diario); ?>" <?php if(old('id_parte_diario', $carga->id_parte_diario)==$parte->id_parte_diario): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $choferes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($ch->id_chofer); ?>" <?php if(old('id_chofer', $carga->id_chofer)==$ch->id_chofer): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="ticket" value="<?php echo e(old('ticket', $carga->ticket)); ?>" maxlength="20" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Fecha Carga <span class="text-danger">*</span></label>
                           <input type="date" name="fecha_carga" value="<?php echo e(old('fecha_carga', $carga->fecha_carga)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.1" min="0" name="peso_bruto" value="<?php echo e(old('peso_bruto', $carga->peso_bruto)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.1" min="0" name="tara" value="<?php echo e(old('tara', $carga->tara)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.1" min="0" name="peso_neto" value="<?php echo e(old('peso_neto', $carga->peso_neto)); ?>" 
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="destino" value="<?php echo e(old('destino', $carga->destino)); ?>" maxlength="100" 
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="d-flex gap-2 justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> Actualizar Carga
                    </button>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/cargas/edit.blade.php ENDPATH**/ ?>