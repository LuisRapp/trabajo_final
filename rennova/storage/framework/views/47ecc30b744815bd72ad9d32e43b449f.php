            ...
            <div class="p-6">
                <form wire:submit.prevent="guardar">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">DNI <!--[if BLOCK]><![endif]--><?php if(!$empleado_id): ?><span class="text-red-500">*</span><?php endif; ?><!--[if ENDBLOCK]><![endif]--></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if($empleado_id): ?> <small class="text-slate-500 text-xs mt-1 block">Opcional - Dejar en blanco para mantener el actual</small> <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                        <div>
