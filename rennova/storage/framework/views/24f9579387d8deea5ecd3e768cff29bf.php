        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
            <div class="bg-slate-50 border-b border-slate-200 px-6 py-4">
                <h5 class="text-lg font-semibold text-slate-800">
                    <?php echo e($rol_id ? '✏️ Editar Rol' : '➕ Nuevo Rol'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex gap-2 justify-end">
                        ...
                        <button type="submit"
                            ...
                            ✓ <?php echo e($rol_id ? 'Actualizar' : 'Guardar'); ?>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr wire:key="row-<?php echo e($rol->id_rol_laboral); ?>" class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-2.5"><span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-600"><?php echo e($rol->id_rol_laboral); ?></span></td>
                                    <td class="px-4 py-2.5 font-medium text-slate-800"><?php echo e($rol->nombre); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.action-buttons','data' => ['editWireClick' => 'editar('.e($rol->id_rol_laboral).')','deleteWireClick' => 'eliminar('.e($rol->id_rol_laboral).')','deleteMessage' => '¿Está seguro de eliminar este rol?','canEdit' => auth()->user()->can('editar-roles-laborales'),'canDelete' => auth()->user()->can('eliminar-roles-laborales')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['editWireClick' => 'editar('.e($rol->id_rol_laboral).')','deleteWireClick' => 'eliminar('.e($rol->id_rol_laboral).')','deleteMessage' => '¿Está seguro de eliminar este rol?','canEdit' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user()->can('editar-roles-laborales')),'canDelete' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(auth()->user()->can('eliminar-roles-laborales'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty-state','data' => ['colspan' => 4,'message' => 'No hay roles registrados.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['colspan' => 4,'message' => 'No hay roles registrados.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <?php endif; ?>
</div><?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/livewire/roles-laborales.blade.php ENDPATH**/ ?>