...
<div class="container py-4">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('choferes.store')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                            ...
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cliente->id_cliente); ?>" <?php if(old('id_cliente')==$cliente->id_cliente): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="apellido" value="<?php echo e(old('apellido')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input" type="checkbox" role="switch" name="estado" id="estado" value="activo" <?php echo e(old('estado', 'activo') == 'activo' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/choferes/create.blade.php ENDPATH**/ ?>