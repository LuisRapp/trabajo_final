<div class="container py-4">
    ...
    <ul class="nav nav-tabs mb-4" id="usuariosTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['crear-usuarios', 'editar-usuarios'])): ?>
        ...
        <div class="tab-pane fade" id="nuevo-usuario" role="tabpanel">
            <div class="card shadow mb-4">
                <div class="card-header bg-light">
                    <h5 class="mb-0"><i class="bi bi-<?php echo e($usuario_id ? 'pencil-square' : 'plus-circle'); ?>"></i> <?php echo e($usuario_id ? 'Editar Usuario' : 'Nuevo Usuario'); ?></h5>
                </div>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" placeholder="Número de teléfono">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Contraseña <!--[if BLOCK]><![endif]--><?php if($usuario_id): ?><span class="text-muted">(dejar vacío para no cambiar)</span><?php else: ?><span class="text-danger">*</span><?php endif; ?><!--[if ENDBLOCK]><![endif]--></label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-md-4">
                        ...
                        <select wire:model="activo" class="form-select <?php $__errorArgs = ['activo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="d-flex gap-2 justify-content-end">
                    <!--[if BLOCK]><![endif]--><?php if($usuario_id): ?>
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> <?php echo e($usuario_id ? 'Actualizar' : 'Guardar'); ?>
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td><i class="bi bi-telephone"></i> <?php echo e($usuario->telefono ?? 'N/A'); ?></td>
                                <td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <button class="btn btn-outline-primary" wire:click="editar(<?php echo e($usuario->id); ?>)" onclick="cambiarAPestanaFormulario()" title="Editar">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                        <?php endif; ?>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-usuarios')): ?>
                                        <button class="btn btn-outline-danger" wire:click="eliminar(<?php echo e($usuario->id); ?>)" onclick="return confirm('¿Está seguro de eliminar este usuario?')" title="Eliminar">
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/usuarios.blade.php ENDPATH**/ ?>