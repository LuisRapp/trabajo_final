            ...
            <?php if(session()->has('command_output')): ?>
                <div x-data="{ open: true }" x-show="open" x-transition
                    ...
                    <div class="flex-1">
                        ...
                        <pre class="mt-2 text-sm whitespace-pre-wrap"><?php echo e(session('command_output')); ?></pre>
                    </div>
                        ...
                        <form wire:submit.prevent="guardarConfiguracion">
                            <div class="mb-4">
                                ...
                                <input type="time"
                                       ...
                                       class="w-full px-4 py-2.5 border rounded-lg text-sm transition-colors <?php $__errorArgs = ['hora_recordatorio'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <select wire:model.live="expresion_cron"
                                    class="w-full px-4 py-2.5 border rounded-lg text-sm transition-colors <?php $__errorArgs = ['expresion_cron'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php else: ?> border-slate-300 focus:border-brand focus:ring-2 focus:ring-brand/20 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4 hidden" id="customCronDiv">
                                ...
                                <input type="text"
                                       ...
                                       class="w-full px-4 py-2.5 border rounded-lg text-sm font-mono transition-colors <?php $__errorArgs = ['expresion_cron'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php else: ?> border-slate-300 focus:border-brand focus:ring-2 focus:ring-brand/20 <?php unset($message);
