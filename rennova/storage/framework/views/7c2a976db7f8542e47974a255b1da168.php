...
<div style="margin-top: 4.5rem;">
    <div class="erp-welcome text-center">Bienvenido <?php echo e(Auth::user()->name ?? 'Usuario'); ?></div>
    <!-- Fila 1 -->
    <div class="erp-card-grid justify-content-center">
        <div class="erp-nav-card">
            ...
            <a href="<?php echo e(route('modulos.maquinaria')); ?>" class="card-btn">Acceder</a>
        </div>
        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-tree"></i></div>
            <div class="card-title">Inventario Forestal</div>
            <a href="<?php echo e(route('modulos.inventario-forestal')); ?>" class="card-btn">Acceder</a>
        </div>
        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-person"></i></div>
            <div class="card-title">Personal</div>
            <a href="<?php echo e(route('modulos.personal')); ?>" class="card-btn">Acceder</a>
        </div>
    </div>
    ...
    <div class="erp-card-grid justify-content-center">
        ...
        <div class="erp-nav-card">
            ...
            <a href="<?php echo e(route('historico-costos-maquinarias.index')); ?>" class="card-btn">Ver Informes</a>
        </div>
        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-shield-lock"></i></div>
            <div class="card-title">Administración</div>
            <a href="<?php echo e(route('modulos.administracion')); ?>" class="card-btn">Configurar</a>
        </div>
    </div>
</div>
