...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="d-flex gap-1 justify-content-center">
                                            <!--[if BLOCK]><![endif]--><?php if($isProgramado): ?>
                                                <button type="button" class="btn btn-sm btn-outline-info" wire:click="confirmarMantenimiento(<?php echo e($mantenimiento->id_mantenimiento); ?>)" title="Confirmar realización">
                                                    <i class="bi bi-check2-circle"></i>
                                                </button>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <!--[if BLOCK]><![endif]--><?php if($isVencido): ?>
                                                <button type="button" class="btn btn-sm btn-outline-warning" wire:click="reprogramarMantenimiento(<?php echo e($mantenimiento->id_mantenimiento); ?>)" title="Reprogramar">
                                                    <i class="bi bi-calendar-plus"></i>
                                                </button>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <button type="button" class="btn btn-sm btn-outline-success" wire:click.prevent="abrirModalCompletar(<?php echo e($mantenimiento->id_mantenimiento); ?>)" title="Completar" <?php if($isCompletado || $isVencido): ?> disabled <?php endif; ?>>
                                                <i class="bi bi-check-circle"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-primary" wire:click="editar(<?php echo e($mantenimiento->id_mantenimiento); ?>)" title="Editar">
                                                <i class="bi bi-pencil"></i>
                                            </button>
                                            <button type="button" class="btn btn-sm btn-outline-danger" wire:click="eliminar(<?php echo e($mantenimiento->id_mantenimiento); ?>)" onclick="return confirm('¿Está seguro de eliminar este mantenimiento?')" title="Eliminar">
    ...
    <?php if (! $__env->hasRenderedOnce('9a848364-11c6-49f7-bff2-329fbe194a70')): $__env->markAsRenderedOnce('9a848364-11c6-49f7-bff2-329fbe194a70'); ?>
        <style>
            .lw-modal-overlay {
                position: fixed;
                inset: 0;
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $insumos_usados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $insumo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row g-2 mb-2 align-items-end">
                            <div class="col-md-6">
                                ...
                                <select wire:model.live="insumos_usados.<?php echo e($index); ?>.id_insumo" class="form-select form-select-sm">
                                    <option value="">Seleccione...</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" wire:model="insumos_usados.<?php echo e($index); ?>.cantidad" step="0.1" min="0" min="0" class="form-control form-control-sm" placeholder="0">
                                <!--[if BLOCK]><![endif]--><?php if(!empty($insumo['id_insumo'])): ?>
                                    <?php
                                        $stockDisponible = \App\Models\MovimientoStock::stockDisponible($insumo['id_insumo']);
                                    ?>
                                    <small class="text-muted">Disponible: <?php echo e(number_format($stockDisponible, 2)); ?></small>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
