            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                <div class="bg-slate-100 border-b border-slate-200 px-6 py-4">
                    <h5 class="flex items-center gap-2 text-lg font-semibold text-slate-800 mb-0">
                        <i class="bi bi-<?php echo e($cliente_id ? 'pencil-square' : 'plus-circle'); ?>"></i> 
                        <?php echo e($cliente_id ? 'Editar Cliente' : 'Nuevo Cliente'); ?>
                    ...
                    <form wire:submit.prevent="guardar">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            <div>
                                ...
                                <input type="text" wire:model="razon_social" placeholder="Nombre del cliente" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors <?php $__errorArgs = ['razon_social'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="contacto" placeholder="Teléfono / Email" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors <?php $__errorArgs = ['contacto'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        <div class="flex items-center gap-2 px-4 py-3 border border-slate-300 rounded-lg bg-slate-50">
                            ...
                            <input type="text" wire:model.live="busqueda" placeholder="Buscar por razón social, CUIT o contacto..." class="flex-1 bg-slate-50 border-0 focus:ring-0 focus:outline-none text-slate-700 placeholder-slate-400">
                        </div>
                    </div>
                            ...
                            <tbody class="divide-y divide-slate-200">
                                <?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-slate-50 transition-colors" wire:key="row-<?php echo e($cliente->id_cliente); ?>">
                                        ...
                                        <td class="px-4 py-3 text-slate-600"><?php echo e($cliente->direccion ?? '-'); ?></td>
                                        <td class="px-4 py-3 text-slate-600"><?php echo e($cliente->contacto ?? '-'); ?></td>
                                        <td class="px-4 py-3 text-center">
                                            <div class="flex gap-1 justify-center">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-clientes')): ?>
                                                <button wire:click="editar(<?php echo e($cliente->id_cliente); ?>)" @click="tab = 'nuevo'" title="Editar" class="inline-flex items-center px-2 py-1 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded transition-colors border border-blue-200">
                                                    <i class="bi bi-pencil text-sm"></i>
                                                </button>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-clientes')): ?>
                                                <button wire:click="eliminar(<?php echo e($cliente->id_cliente); ?>)" onclick="return confirm('¿Está seguro de eliminar este cliente?')" title="Eliminar" class="inline-flex items-center px-2 py-1 bg-red-50 text-red-700 hover:bg-red-100 rounded transition-colors border border-red-200">
...
</script><?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/livewire/clientes.blade.php ENDPATH**/ ?>