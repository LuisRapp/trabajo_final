...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">
                            Umbral de Toneladas 
                            <i class="bi bi-info-circle text-muted" data-bs-toggle="tooltip" title="Toneladas acumuladas que disparan mantenimiento preventivo automático"></i>
                        </label>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        <small class="text-muted">Toneladas para activar mantenimiento preventivo</small>
                    </div>
                </div>
                <div class="d-flex gap-2 justify-content-end">
                    <!--[if BLOCK]><![endif]--><?php if($tipo_id): ?>
                ...
                <table class="table table-hover align-middle">
                    <thead class="table-light">
                        <tr>
                            <th>ID</th>
                            <th>Nombre</th>
                            <th>Umbral de Toneladas</th>
                            <th class="text-end">Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if($tipo->umbral_toneladas): ?>
                                        <span class="badge bg-info">
                                            <i class="bi bi-speedometer2"></i> <?php echo e(number_format($tipo->umbral_toneladas, 2)); ?> tn
                                        </span>
                                    <?php else: ?>
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/tipos-maquinaria.blade.php ENDPATH**/ ?>