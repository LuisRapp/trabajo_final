            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
                <div class="bg-slate-100 border-b border-slate-200 px-6 py-4">
                    <h5 class="flex items-center gap-2 text-lg font-semibold text-slate-800 mb-0">
                        <i class="bi bi-<?php echo e($maquinaria_id ? 'pencil-square' : 'plus-circle'); ?>"></i> 
                        <?php echo e($maquinaria_id ? 'Editar Maquinaria' : 'Nueva Maquinaria'); ?>
                    ...
                    <form wire:submit.prevent="guardar">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <div>
                                ...
                                <select wire:model="id_tipo_maquinaria" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors <?php $__errorArgs = ['id_tipo_maquinaria'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="modelo" placeholder="Modelo de la maquinaria" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors <?php $__errorArgs = ['modelo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <div>
                                ...
                                <select wire:model="es_alquilada" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors <?php $__errorArgs = ['es_alquilada'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.1" min="0" wire:model="umbral_toneladas" placeholder="Ej: 100.00" class="w-full px-4 py-3 border border-default rounded-lg focus:border-green-700 focus:ring-2 focus:ring-green-600 transition-colors <?php $__errorArgs = ['umbral_toneladas'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500 <?php unset($message);
                                    ...
                                    <tr class="hover:bg-slate-50 transition-colors" wire:key="row-<?php echo e($maquinaria->id_maquinaria); ?>">
                                        ...
                                        <td class="px-3 py-3">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                                <?php echo e($maquinaria->estado == 'operativa' ? 'bg-green-50 text-green-700 border border-green-200' : 
                                        ...
                                        <td class="px-3 py-3 text-slate-600">
                                            <?php if($maquinaria->es_alquilada): ?>
                                        ...
                                        <td class="px-3 py-3 text-slate-600"><?php echo e($maquinaria->fecha_inicio_actividades ? \Carbon\Carbon::parse($maquinaria->fecha_inicio_actividades)->format('d/m/Y') : 'N/A'); ?></td>
                                        <td class="px-3 py-3 text-center">
                                            <div class="flex gap-1 justify-center">
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-maquinarias')): ?>
                                                <button wire:click="editar(<?php echo e($maquinaria->id_maquinaria); ?>)" @click="$set('tab_activo', 'nuevo')" title="Editar" class="inline-flex items-center px-2 py-1 bg-blue-50 text-blue-700 hover:bg-blue-100 rounded transition-colors border border-blue-200">
                                                    <i class="bi bi-pencil text-sm"></i>
                                                </button>
                                                <?php endif; ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-maquinarias')): ?>
                                                <button wire:click="eliminar(<?php echo e($maquinaria->id_maquinaria); ?>)" onclick="return confirm('¿Está seguro de eliminar esta maquinaria?')" title="Eliminar" class="inline-flex items-center px-2 py-1 bg-red-50 text-red-700 hover:bg-red-100 rounded transition-colors border border-red-200">
...
</script><?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/livewire/maquinarias.blade.php ENDPATH**/ ?>