...
<head>
    <meta charset="utf-8">
    <title><?php echo e($reporte_nombre ?? 'Reporte de Lluvias'); ?></title>
    <style>
        @page {
...
<body>
        ...
        <table style="width: 100%;">
            <tr>
                <td style="width: 20%; vertical-align: top;">
                    <?php if($mostrarLogo): ?>
                        <img src="<?php echo e($logoPath); ?>" style="height: 65px;" alt="Logo">
                    <?php endif; ?>
                </td>
                <td style="width: 80%; text-align: right; vertical-align: top;">
                    <h1 class="title-report">REPORTE DIAS CON LLUVIA</h1>
                    <div class="subtitle-report">Periodo: <?php echo e($periodo ?? '-'); ?></div>
                    <?php if(!empty($lote_seleccionado)): ?>
                        <div class="meta-block">Lote: <?php echo e($lote_seleccionado->ubicacion ?? $lote_seleccionado->propietario ?? ('Lote ' . $lote_seleccionado->id_lote)); ?></div>
                    <?php else: ?>
    ...
    <footer>
        Reporte del clima - Generado por: <?php echo e($generado_por ?? '-'); ?> | Fecha y hora: <?php echo e($fecha_hora ?? '-'); ?>
    ...
    <main>
        <table class="kpi-container">
            <tr>
                <td style="width: 33%; padding-right: 10px;">
                    <div class="kpi-card">
                        <span class="kpi-value"><?php echo e($total_registros ?? 0); ?></span>
                        <span class="kpi-label">Dias con lluvia</span>
                    </div>
                </td>
                <td style="width: 33%; padding-right: 10px;">
                    <div class="kpi-card">
                        <span class="kpi-value"><?php echo e($total_lotes ?? 0); ?></span>
                        <span class="kpi-label">Lotes afectados</span>
                    </div>
                </td>
                <td style="width: 33%;">
                    <div class="kpi-card">
                        <span class="kpi-value"><?php echo e($periodo ?? '-'); ?></span>
        ...
        <table class="table-data">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $registros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <tr>
                        <td><?php echo e($fecha->format('d/m/Y')); ?></td>
                        <td><?php echo e($diaSemana); ?></td>
                        <td><?php echo e($loteNombre); ?></td>
                        <td><?php echo e($mm !== null ? number_format((float) $mm, 1) : '-'); ?></td>
                        <td><?php echo e($registro->razon_real ?? '-'); ?></td>
                        <td><?php echo e(strtoupper($registro->fuente_real ?? '-')); ?></td>
                    </tr>
        ...
        <?php if(!empty($dias_por_lote)): ?>
            ...
            <table class="table-data">
                ...
                <tbody>
                    <?php $__currentLoopData = $dias_por_lote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($item['lote']); ?></td>
                            <td><?php echo e($item['cantidad']); ?></td>
                            <td><?php echo e(number_format((float) ($item['mm_total'] ?? 0), 1)); ?></td>
                        </tr>
...
<?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/reportes/pdf/clima-lluvias.blade.php ENDPATH**/ ?>