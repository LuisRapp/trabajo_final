<div class="container py-4">
    <!--[if BLOCK]><![endif]--><?php if(!empty($loteId)): ?>
    ...
    <div class="tab-content">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($p->id_lote_tarea): ?>
        ...
        <div class="tab-pane fade <?php echo e(!$mostrar_listado ? 'show active' : ''); ?>">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <!--[if BLOCK]><![endif]--><?php if(!$selectedProposal): ?>
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                <div class="card border-secondary h-100">
                                    ...
                                    <div class="card-body">
                                        <!--[if BLOCK]><![endif]--><?php if($selectedProposal->proposedEmployees->isEmpty()): ?>
                                        ...
                                        <?php else: ?>
                                            <div style="max-height: 320px; overflow-y: auto;" class="border rounded p-2">
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedProposal->proposedEmployees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-md-4">
                                <div class="card border-primary h-100">
                                    ...
                                    <div class="card-body">
                                        <!--[if BLOCK]><![endif]--><?php if($selectedProposal->proposedMaquinarias->isEmpty()): ?>
                                            <div class="text-muted small">Sin sugerencias (falta histórico/pivotes).</div>
                                        <?php else: ?>
                                            <div style="max-height: 320px; overflow-y: auto;" class="border rounded p-2">
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedProposal->proposedMaquinarias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="form-check">
                                                        <input
                                                            class="form-check-input"
                                                            type="checkbox"
                            ...
                            <div class="col-md-4">
                                <div class="card border-success h-100">
                                    ...
                                    <div class="card-body">
                                        <!--[if BLOCK]><![endif]--><?php if($selectedProposal->proposedInsumos->isEmpty()): ?>
                                            <div class="text-muted small">Sin sugerencias.</div>
                                        <?php else: ?>
                                            <div style="max-height: 320px; overflow-y: auto;" class="border rounded p-2">
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $selectedProposal->proposedInsumos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="d-flex align-items-start gap-2 py-1">
                                                        ...
                                                        <label class="w-100" for="api-<?php echo e($row->id_allocation_proposal_insumo); ?>">
                                                            ...
                                                            <div class="small text-muted">
                                                                ...
                                                                <!--[if BLOCK]><![endif]--><?php if(!is_null($row->cantidad_semana_1)): ?>
                                                                    · cant. semana 1: <strong><?php echo e($row->cantidad_semana_1); ?></strong>
                                                                <?php else: ?>
                                                                    · cant. semana 1: <strong>N/A</strong>
                                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                                                                <!--[if BLOCK]><![endif]--><?php if(!is_null($row->costo_estimado_semana_1)): ?>
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/allocation-proposals.blade.php ENDPATH**/ ?>