<div class="container py-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <!-- Filtros Colapsables -->
            <!--[if BLOCK]><![endif]--><?php if($mostrarFiltros): ?>
                ...
                <div class="row g-3 mb-3 pb-3 border-bottom">
                    ...
                    <div class="col-md-3">
                        ...
                        <select wire:model.live="filtroModelo" class="form-select">
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $modelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $auditorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auditoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if($auditoria->event === 'created'): ?>
                                ...
                                <td>
                                    <!--[if BLOCK]><![endif]--><?php if($auditoria->user): ?>
    ...
    <!-- Modales de Detalles -->
    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $auditorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $auditoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($auditoria->url): ?>
                            <div class="mb-3">
                                <strong>URL:</strong> <code class="d-block bg-light p-2 rounded"><?php echo e($auditoria->url); ?></code>
                            </div>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                        <!--[if BLOCK]><![endif]--><?php if($auditoria->event === 'updated' && $auditoria->old_values && $auditoria->new_values): ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm table-bordered">
                                    ...
                                    <tbody>
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $auditoria->new_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campo => $valorNuevo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <!--[if BLOCK]><![endif]--><?php if(isset($auditoria->old_values[$campo]) && $auditoria->old_values[$campo] != $valorNuevo): ?>
                                                <tr>
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/auditorias.blade.php ENDPATH**/ ?>