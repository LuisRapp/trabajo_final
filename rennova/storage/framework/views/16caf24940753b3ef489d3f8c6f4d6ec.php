                            ...
                            <div class="list-group">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item d-flex justify-content-between align-items-center <?php echo e($selectedRole == $role->id ? 'active' : ''); ?>" 
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($role->name !== 'Administrador'): ?>
                                            <button type="button" 
                        ...
                        <div class="card-body">
                            <!--[if BLOCK]><![endif]--><?php if($selectedRole): ?>
                                <form wire:submit.prevent="updateRolePermissions">
                                    <div class="row">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $modulePermissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6 mb-4">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $modulePermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item <?php echo e($selectedUser == $user->id ? 'active' : ''); ?>" 
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($user->roles->isNotEmpty()): ?>
...
<?php /**PATH D:\trabajo_final\rennova\resources\views/livewire/roles-permisos.blade.php ENDPATH**/ ?>