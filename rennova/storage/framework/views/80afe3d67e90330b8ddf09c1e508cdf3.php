        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mb-6">
            <div class="bg-slate-50 border-b border-slate-200 px-6 py-4">
                <h5 class="text-lg font-semibold text-slate-800">
                    <?php echo e($kit_id ? '✏️ Editar Kit' : '➕ Nuevo Kit'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex gap-2 justify-end">
                        ...
                        <button type="submit"
                            ...
                            ✓ <?php echo e($kit_id ? 'Actualizar' : 'Guardar'); ?>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <?php $__empty_1 = true; $__currentLoopData = $kits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr wire:key="row-<?php echo e($kit->id_kit_preventivo); ?>" class="hover:bg-slate-50 transition-colors">
                                    <td class="px-4 py-2.5"><span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-slate-100 text-slate-600"><?php echo e($kit->id_kit_preventivo); ?></span></td>
                                    <td class="px-4 py-2.5 font-medium text-slate-800"><?php echo e($kit->nombre); ?></td>
                                    <td class="px-4 py-2.5 text-slate-600"><?php echo e($kit->descripcion ?? '-'); ?></td>
