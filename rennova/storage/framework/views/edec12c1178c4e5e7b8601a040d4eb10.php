                                ...
                                <div class="p-4">
                                    <div class="space-y-3 text-sm">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span><?php echo e($calculo['cantidad_dias_caidos']); ?> días</span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <span class="font-semibold">Jornal diario</span>
                                            <span>$<?php echo e(number_format($calculo['valor_jornal'], 2)); ?></span>
                                        </div>
                                        <div class="flex items-center justify-between rounded-md bg-slate-50 px-3 py-2">
                                            ...
                                            <span class="font-semibold">$<?php echo e(number_format($calculo['total_pagar_jornales'], 2)); ?></span>
                                        </div>
                                        <hr>
                                        <div class="flex items-center justify-between">
                                            <span class="font-semibold">Toneladas producidas</span>
                                            <span><?php echo e(number_format($calculo['total_peso_toneladas'] ?? 0, 2)); ?> ton</span>
                                        </div>
                                        <div class="flex items-center justify-between">
                                            <span class="font-semibold">Tarifa por tonelada</span>
                                            <span>$<?php echo e(number_format($calculo['tarifa_fija_por_tonelada'], 2)); ?></span>
                                        </div>
                                        <div class="flex items-center justify-between rounded-md bg-slate-50 px-3 py-2">
                                            <span class="font-semibold">Subtotal producción</span>
                                            <span class="font-semibold">$<?php echo e(number_format($calculo['total_pagar_produccion'], 2)); ?></span>
                                        </div>
                                        <hr>
                                        <div class="flex items-center justify-between rounded-md bg-green-50 px-3 py-2 text-green-800">
                                            ...
                                            <span class="text-lg font-bold">$<?php echo e(number_format($calculo['total_pagar_final'], 2)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <?php if(count($adelantos_pendientes) > 0): ?>
                                            ...
                                            <table class="min-w-full text-sm">
                                                ...
                                                <tfoot class="bg-amber-100">
                                                    <tr>
                                                        ...
                                                        <th class="px-3 py-2 text-right">$<?php echo e(number_format($total_adelantos, 2)); ?></th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div>
                                        ...
                                        <div class="rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-green-800">
                                            <div class="text-2xl font-bold">$<?php echo e(number_format($monto_neto, 2)); ?></div>
                                        </div>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" maxlength="150"></textarea>
...
</div><?php /**PATH /home/rluis/Escritorio/trabajo_final/rennova/resources/views/livewire/liquidacion-pagos.blade.php ENDPATH**/ ?>