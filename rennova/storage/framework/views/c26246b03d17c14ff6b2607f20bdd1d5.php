...
<div class="container py-4">
    ...
    <div class="erp-card-grid">
        <div class="erp-nav-card">
            ...
            <a href="<?php echo e(route('empleados.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-person-vcard"></i></div>
            <div class="card-title">Choferes</div>
            <a href="<?php echo e(route('choferes.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-cash-coin"></i></div>
            <div class="card-title">Adelantos</div>
            <a href="<?php echo e(route('adelantos.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-file-earmark-text"></i></div>
            <div class="card-title">Recibos</div>
            <a href="<?php echo e(route('recibos.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-calculator"></i></div>
            <div class="card-title">Liquidación de Pagos</div>
            <a href="<?php echo e(route('liquidacion-pagos.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-link-45deg"></i></div>
            <div class="card-title">Asignaciones por Lote</div>
            <a href="<?php echo e(route('asignaciones-lote.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-person-badge"></i></div>
            <div class="card-title">Roles Laborales</div>
            <a href="<?php echo e(route('roles-laborales.index')); ?>" class="card-btn">Gestionar</a>
        </div>

        <div class="erp-nav-card">
            <div class="erp-icon"><i class="bi bi-clock-history"></i></div>
            <div class="card-title">Histórico Roles</div>
            <a href="<?php echo e(route('historico-roles-laborales.index')); ?>" class="card-btn">Ver Histórico</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\trabajo_final\rennova\resources\views/modulos/personal.blade.php ENDPATH**/ ?>